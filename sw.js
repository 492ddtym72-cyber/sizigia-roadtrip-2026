...
const CACHE = 'sizigia-app-v42-generated-png-game-art';
const APP_ASSETS = [
  './',
  './index.html',
  ...
  './game-assets/production/sprites/psy-bird.png',
  './game-assets/production/sprites/psy-pillar.png',
  './game-assets/production/raster/background.000.txt',
  './game-assets/production/raster/background.001.txt',
  './game-assets/production/raster/background.002.txt',
  './game-assets/production/raster/background.003.txt',
  './game-assets/production/raster/background.004.txt',
...
self.addEventListener('fetch', e => {
  ...
  const isAppShell = e.request.mode === 'navigate' ||
    ...
    url.pathname.endsWith('/psy-bird.png') ||
    url.pathname.endsWith('/psy-pillar.png') ||
    url.pathname.includes('/game-assets/production/raster/') ||
